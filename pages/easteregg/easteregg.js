...
Page({
  ...
  onLoad: function (options) {
    db.collection("snake").doc("0bcbdde05fd610ee0145bbbf1796b3ab").get({
      success:res=>{
        console.log(res)
        this.setData({
          netmaxscore:res.data.score
        })
      }
    })
  ...
  modalConfirm:function(){
    ...
    if(this.data.maxscore>this.data.netmaxscore){
      db.collection("snake").doc("0bcbdde05fd610ee0145bbbf1796b3ab").update({
        data:{
          score:this.data.maxscore
        }
      }).then(res=>{
        console.log(res)
      })
